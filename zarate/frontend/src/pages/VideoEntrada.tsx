...
export function VideoEntrada() {
    ...
    useEffect(() => {
        ...
        socketRef.current.on('connect', () => {
            console.log('Conectado al servidor  ENTRADA');
        });

        socketRef.current.on('disconnect', () => {
            console.log('Desconectado del servidor  ENTRADA');
        });

        socketRef.current.on('no_permitido', async (data: any) => {
            console.log('ENTRADA ')
        ...
        socketRef.current.on('autoexcluido', async (data: any) => {
            console.log('ENTRADAAA')
            playAlertSound()
            // Aquí puedes manejar la alerta recibida, por ejemplo, mostrando una notificación
            if (data) {
        ...
        socketRef.current.on('menor_edad', async (data: any) => {
            console.log('ENTRADAAA')
            console.log('Alerta recibida:', data);
            playAlertSound();
            if (data) {
