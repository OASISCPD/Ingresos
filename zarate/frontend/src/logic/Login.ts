  ...
  try {
    ...
    Swal.fire({
      ...
      html: `
          ...
          <button id="closeBtn" class="w-full text-white bg-gradient-to-r from-backgroundBlack to-backgroundRed focus:ring-4 focus:outline-none focus:ring-primary-300 my-8 rounded-3xl  px-5 py-2.5 text-center text-xl">Cerrar</button>
        `,
