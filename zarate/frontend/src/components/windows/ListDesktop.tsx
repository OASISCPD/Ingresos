...
export function ListDesktop({ domain }: domain) {
            ...
            <div className='lg:my-4 xl:my-20 2xl:my-20 '>
                ...
                {loading ? (
                    <div style={{ maxHeight: maxHeight, overflowY: 'auto', overflowX: "auto" }} className="scrollbar my-2 xl:my-8 2xl:my-12 text-xl xl:text-2xl relative overflow-x-auto border-4 border-backgroundForm rounded-xl shadow-lg animate-pulse bg-white">
                        <div style={{ zIndex: 100 }} className="block max-w-full sm:p-2 backgroundOpacityBlack  p-1  rounded-lg  shadow ">
                            <div className='p-2 bg-red-100 m-2 my-3 rounded-lg text-white'>
                                <p className="">asdjnaskjd </p>
                                <p className="">asdklmasdklmasld</p>
                            </div>
                            <div className='p-2 bg-red-100 m-2 my-3 rounded-lg text-white'>
                                <p className="">asdjnaskjd </p>
                                <p className="">asdklmasdklmasld</p>
