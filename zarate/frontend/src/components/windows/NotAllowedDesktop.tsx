...
export function NotAllowedDesktop() {
    ...
    return (
        <div>
            ...
            {checkButtonModal && (
                <div>
                    <button style={{ textShadow: "1px 2px 2px rgba(0,0,0,0.5)" }} onClick={sendData} className="bg-buttonSend shadow-md hover:bg-violet-500 text-white py-2 px-12 rounded-md">
                        Agregar
                    </button>
                </div>
            )}
