                ...
                <div className="flex text-black flex-wrap relative items-center justify-center">
                    ...
                    <div>
                        <input
                            ...
                            className="mx-4 hover:bg-waterGreenAllBlack bg-waterGreenBlack px-4 py-1 rounded-full text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-backgroundButtonRed z-0 focus:border-transparent"
                        />
                    </div>
                </div>
                <div className="border-l-2 border-l-backgroundForm flex items-center justify-center">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="bg-white border border-gray-300 rounded-full py-1 px-4 placeholder-gray-500 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-backgroundButtonRed z-0 focus:border-transparent w-64 "
