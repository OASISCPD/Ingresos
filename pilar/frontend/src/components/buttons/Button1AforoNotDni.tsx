...
export function Button1AforoNotDni() {
    ...
    return (
        <button type="button" style={{ textShadow: "1px 2px 2px rgba(0,0,0,0.5)" }} onClick={send} className={`flex justify-center items-center shadow-md shadow-backgroundGrayBlack text-base sm:text-lg lg:text-sm xl:text-xl py-2.5 mx-auto w-full bg-gradient-to-b from-backgroundButtonOraenge to-backgroundButtonOraengeGradient rounded-md text-white shadowText`}>
