    ...
    return (
        <>
            ...
            <div style={{ zIndex: 0 }} className='my-4 '>
                ...
                {loading ? (
                    <div style={{ maxHeight: maxHeight, overflowY: 'auto', overflowX: "auto" }} className="text-base scrollbar sm:text-xl relative overflow-x-auto border-4 border-backgroundForm rounded-md shadow-lg animate-pulse bg-white ">
                        <div className="block max-w-full sm:p-2 backgroundOpacityBlack p-1     shadow ">
                            <div className='p-2 bg-teal-100 m-2  rounded-md min-h-8 sm:min-h-16 text-white text-sm'>
                            </div>
                            <div className='p-2 bg-teal-100 m-2  rounded-md min-h-8 sm:min-h-16 text-white text-sm'>
                            </div>
                            <div className='p-2 bg-teal-100 m-2  rounded-md min-h-8 sm:min-h-16 text-white text-sm'>
                    ...
                    <div style={{ maxHeight: maxHeight, overflowY: 'auto', overflowX: "auto" }} className="text-sm scrollbar sm:text-base relative overflow-x-auto border-4 border-waterGreenShadow rounded-md shadow-lg ">
                        {clients.map((client, index) => (
                            <div key={index} className="block max-w-full sm:p-2 bg-black bg-opacity-70 p-1     shadow ">
                                {/* REALIZAR MAPEO PARA LAS LISTA  */}
                                <div className='p-2 bg-waterGreenShadow m-2  rounded-md text-white'>
