    ...
    return (
        <div className='container mx-auto'>
            <div className='grid grid-cols-2 gap-4 items-center my-8'>
                ...
                <div className=''>
                    <div onClick={openModal} style={{ textShadow: "1px 2px 2px rgba(0,0,0,0.5)" }} className={`flex justify-center focus:outline-none items-center text-sm  p-2.5 mx-auto w-full bg-gradient-to-b shadow-md cursor-pointer hover:scale-105 duration-200 2xl:text-base shadow-backgroundGrayBlack from-waterGreenShadow to-waterGreenBlack rounded-md text-white`}>
