                        ...
                        <form className=" space-y-6" onSubmit={handleSubmit}>
                            <div>
                                ...
                                <input
                                    ...
                                    className="bg-gray-50 border border-sideBarBackgroundOrange text-black text-sm rounded-md leading-tight focus:shadow-outline focus:outline-none focus:border-red-200 focus:ring focus:ring-backgroundRed block w-full p-2.5"
                                    placeholder="Legajo"
                                    required
                                    autoComplete="off"
                                />
                            ...
                            <div>
                                <button
                                    type="submit"
                                    className="w-full text-white bg-gradient-to-r from-backgroundBlack to-backgroundRed focus:ring-4 focus:outline-none focus:ring-primary-300  rounded-md text-sm px-5 py-2.5 text-center"
                                >
                                    Ingresar
                                </button>
                            </div>
